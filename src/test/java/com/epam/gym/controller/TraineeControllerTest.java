...
class TraineeControllerTest {
    ...
    void shouldCreateTrainee() throws Exception {
        var requestDTO = TraineeRequestDTO.builder()
                ...
                .firstName("John")
                .lastName("Doe")
                .dateOfBirth(LocalDate.of(1995, 12, 7))
                .build();
    ...
    void shouldGetTraineeById() throws Exception {
        Long traineeId = 1L;
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/trainees/{id}", traineeId)
                        .contentType(MediaType.APPLICATION_JSON))
    ...
    void shouldUpdateTrainee() throws Exception {
        var updateDTO = TraineeUpdateDTO.builder()
                ...
                .isActive(false)
                .build();
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/trainees")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void shouldDeleteTrainee() throws Exception {
        Long traineeId = 1L;
        mockMvc.perform(MockMvcRequestBuilders.delete("/api/v1/trainees/{id}", traineeId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    void shouldUpdateTraineeTrainers() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/api/v1/trainees/{id}/trainers", traineeId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(asJsonString(trainerIds)))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    void shouldGetTraineeTrainings() throws Exception {
        Long traineeId = 1L;
        mockMvc.perform(MockMvcRequestBuilders.get("/api/v1/trainees/{id}/trainings", traineeId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(MockMvcResultMatchers.status().isOk());
    }
    ...
    void shouldToggleTraineeActiveStatus() throws Exception {
        ToggleActiveDTO toggleActiveDTO = ToggleActiveDTO.builder()
                .id(1L)
                .isActive(true)
                .build();
        mockMvc.perform(MockMvcRequestBuilders.patch("/api/v1/trainees/toggle-active")
                        .contentType(MediaType.APPLICATION_JSON)
